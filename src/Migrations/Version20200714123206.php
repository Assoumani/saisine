 ...
 */
final class Version20200714123206 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE ticket_id ticket_id INT DEFAULT NULL, CHANGE author_role author_role VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
