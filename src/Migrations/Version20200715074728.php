 ...
 */
final class Version20200715074728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message CHANGE ticket_id ticket_id INT DEFAULT NULL, CHANGE author_role author_role VARCHAR(255) DEFAULT NULL, CHANGE file file VARCHAR(255) DEFAULT NULL');
