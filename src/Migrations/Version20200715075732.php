 ...
 */
final class Version20200715075732 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message DROP file, CHANGE ticket_id ticket_id INT DEFAULT NULL, CHANGE author_role author_role VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE ticket ADD files JSON DEFAULT NULL, CHANGE department_id department_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) DEFAULT NULL, CHANGE surname surname VARCHAR(255) DEFAULT NULL, CHANGE field_activity field_activity VARCHAR(255) DEFAULT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE ticket_number ticket_number VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message ADD file VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE ticket_id ticket_id INT DEFAULT NULL, CHANGE author_role author_role VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
